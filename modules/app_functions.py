...
class AppFunctions(MainWindow):
    def setThemeHack(self):
        ...
        border-left: 22px solid qlineargradient(spread:pad, x1:0.034, y1:0, x2:0.216, y2:0, stop:0.499 rgba(249, 178, 0, 255), stop:0.5 rgba(255, 211, 0, 0));
        background-color: rgba(231, 81, 19, 130); 
        """
        # 566388;
        # SET MANUAL STYLES
