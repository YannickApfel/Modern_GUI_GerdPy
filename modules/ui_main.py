...
################################################################################
## Form generated from reading UI file 'mainvebMPU.ui'
##
...
#if QT_CONFIG(tooltip)
        self.label_75.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:11pt;\">Thermal conductivity of concrete material heating element.</span></p><p><span style=\" font-size:11pt;\">Schematics symbol: lambda_C</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
