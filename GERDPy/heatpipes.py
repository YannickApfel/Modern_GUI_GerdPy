...
class Heatpipes(object):
    ...
    def __init__(self, N, r_b, r_w, r_iso_b, r_pa, r_pi, lambda_b, lambda_iso, lambda_p):
        self.N = int(N)
        self.r_b = float(r_b)
        self.r_w = float(r_w)
        self.r_iso_b = float(r_iso_b)
    ...
    def __repr__(self):
        s = ('Heatpipes(N={self.N}, r_w={self.r_w}, r_iso_b={self.r_iso_b}, r_pa={self.r_pa},'
